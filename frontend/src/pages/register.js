...
function Register() {
    ...
    function matchPassword(tmpPass1, tmpPass2) {
        setPasswordMatchMsg(
            tmpPass1 === tmpPass2 ? "" : "Password did not match"
        );
        ...
        <div class="App2 center">
            <div className="card2 center" id="card_reg">
                    ...
                    <div className="login_with_cred center">
                        ...
                        <div className="linear">
                            <input
                                ...
                                placeholder="Email"
                            />
                            <p style={{ color: emailValidationColor }}>
                                {emailValidationMsg}
                            </p>
                        </div>
                        <div className="linear">
                            <input
                                ...
                                onChange={(e) => [
                                    ...
                                    validateUsename(e.target.value),
                                ]}
                                type="text"
                        ...
                        <div className="linear">
                            <input
                                ...
                                onChange={(e) => [
                                    ...
                                    matchPassword(e.target.value, password),
                                ]}
                                type="text"
                                placeholder="Confirm Password"
                            />
                            <p style={{ color: passwordMatchColor }}>
                                {passwordMatchMsg}
                            </p>
                        </div>
                    </div>
                ...
                <div className="center">
                    <button className="login_shape" onClick={registerUser}>
                        Register
                    </button>
