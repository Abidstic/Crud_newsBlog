...
function BlogCard(prop) {
    ...
    return error ? (
        <NotFound code={errorCode} msg={errorMsg} />
    ) : deleted ? (
        <pre className="strikethrough">[Deleted]</pre>
    ) : (
        <div className="card">
            ...
            <div className="card-footer">
                {blog.uploader === parseInt(localStorage.getItem("userID")) ? (
                    <div className="modify">
                        <button onClick={() => setEditBlogMode(blog.id)}>
                            Edit Blog
                        </button>
                ...
                <div className="comment">
                    <button className="btn" onClick={() => giveMessage()}>
                        Comment
                    </button>
                </div>
            </div>
